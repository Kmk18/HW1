...
def padding_img(img, filter_size=3):
    ...
    padded_img = cv2.copyMakeBorder(img, pad_width, pad_width, pad_width, pad_width, cv2.BORDER_REPLICATE)
    return padded_img
